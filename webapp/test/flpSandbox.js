		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#materialsoverview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"materialsoverview-display": {
								"semanticObject": "materialsoverview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=materialsoverview",
									"url": sap.ui.require.toUrl("materialsoverview")
								}
							}
						}
					}
